...
@section('content')
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Edit Main Menu</h4>
                </div>
                <div class="col-lg-6">
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <form id="MenuForm" action="{{ route('admin.main-menu-update') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="slug" id="slug"
                                            placeholder="slug in english" value="{{ $data->slug }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
