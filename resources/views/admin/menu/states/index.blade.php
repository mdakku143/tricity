...
@section('title', 'PHM News - Admin - States')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">States</h4>
                </div>
                <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-end mb-2">
                            <a href="{{ route('admin.states-form') }}"
                                class="btn btn-sm btn-soft-success waves-effect waves-light">Add State</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success waves-effect waves-light edit-btn"
                                                        title="Edit" href="{{ route('admin.states-edit', $item->id) }}">
        ...
        $(document).on('click', '.deleteCategory', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: appUrl + "/admin/states-delete",
                        type: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
