<link rel="icon" href="{{ asset('frontend/images/icon/logo.jpg') }}" type="image/x-icon" />
<link rel="icon" href="{{ asset('frontend/images/icon/favicon.jpg') }}" type="image/x-icon" />
...
<link rel="stylesheet" href="{{ asset('admin/assets/css/font-awesome/css/font-awesome.min.css') }}">
<link href="{{ asset('admin/assets/libs/bs-stepper/css/bs-stepper.css') }}" rel="stylesheet" />
