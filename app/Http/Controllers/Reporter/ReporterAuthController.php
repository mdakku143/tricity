...
use App\Mail\ReporterPendingApproval;
...
class ReporterAuthController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // if ($reporter) {
            //     // Send email to admin
            //     Mail::to(['akkuapsi@gmail.com'])->send(new ReporterPendingApproval($reporter, true));

            //     // Send confirmation email to user
            //     Mail::to($reporter->email)->send(new ReporterPendingApproval($reporter, false));
            // }
            DB::commit();
    ...
    {
        // dd('Logged in');
        return view('website.reporter.dashboard');
    }
